...
/*!
 ...
 @updated 2025-07-19
 @brief Hash table type for C/C++.
 @discussion
    Implementation is included when PAUL_TABLE_IMPLEMENTATION or PAUL_IMPLEMENTATION is defined.
*/
...
#if defined(PAUL_IMPLEMENTATION) || defined(PAUL_TABLE_IMPLEMENTATION)
#include <assert.h>
#include <stdlib.h>
#include <string.h>
#include <time.h>
